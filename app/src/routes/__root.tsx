...
function buildHead(meta: AppMeta) {
  const title = meta.og_title ?? "Ashford Community Energy"; const description = meta.og_description ?? "Community-led clean energy for Ashford."; const ogImage = "https://ace-website-tawny.vercel.app/assets/brand/ace-og.png"; const favicon = meta.favicon_url ?? "/assets/brand/favicon-32.png";
